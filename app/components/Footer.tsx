...
const categoryLinks = [
  ...
  { href: "/category/accessory", label: "اکسسوری" },
];

const serviceLinks = [
  { href: "/legal/shipping", label: "روش‌های ارسال" },
  { href: "/legal/returns", label: "شرایط بازگشت کالا" },
  { href: "/legal/privacy", label: "حریم خصوصی" },
  { href: "/legal/terms", label: "قوانین و مقررات" },
  { href: "/legal/complaints", label: "ثبت شکایت" },
];
