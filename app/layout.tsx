...
export const metadata: Metadata = {
  ...
  title: {
    default: 'احسان صالحی | متخصص IT با ۲۰ سال تجربه',
    template: '%s | احسان صالحی',
  },
  description:
    'احسان صالحی، متخصص IT با ۲۰ سال تجربه در زمینه شبکه، امنیت، توسعه وب و هوش مصنوعی. ارائه خدمات مشاوره، طراحی سایت و اتوماسیون.',
  keywords: [
    'احسان صالحی',
    'متخصص IT',
    'شبکه',
  ...
  openGraph: {
    ...
    siteName: 'احسان صالحی',
    title: 'احسان صالحی | متخصص IT با ۲۰ سال تجربه',
    description: 'متخصص IT، توسعه‌دهنده فول استک، معمار شبکه و مشاور فناوری اطلاعات با ۲۰ سال تجربه',
    images: [
      {
