...
export default function NewsPage() {
  ...
  const handleSearch = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setSearch(value);
    // به‌روزرسانی URL برای قابلیت اشتراک‌گذاری
  ...
  if (error) {
    return (
      <main className="min-h-screen bg-[#0a0a0a] text-white py-20 px-4 flex items-center justify-center">
...
// کامپوننت کارت خبر (تکراری از NewsSection اما با اندکی تغییر)
