...
/**
 * ═══════════════════════════════════════════════════════════
 *  تشخیص وضعیت هاست — نسخه PHP (وقتی SSH نداریم)
 *
 *  نصب:
 *    ۱) این فایل را با FTP در public_html آپلود کنید
 *    ۲) مقدار SECRET پایین را عوض کنید
 *    ۳) باز کنید: https://yourdomain.ir/diagnose.php?key=SECRET
 *    ۴) خروجی را کپی و برای من بفرستید
 *    ۵) ⚠️ بعد از تشخیص، حتماً فایل را پاک کنید
 * ═══════════════════════════════════════════════════════════
 */

const SECRET = 'CHANGE-ME-123456';   // ← این را عوض کنید
